...
public class ManageOrder extends javax.swing.JFrame {
    ...
    public ManageOrder() {
        initComponents();
        setTitle("ManageOrder");
        setSize(1366, 768);
        setDefaultCloseOperation(ManageOrder.EXIT_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Impact", 1, 56)); // NOI18N
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 384, 298));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(58, 96, 110));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 468, 298));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(58, 96, 110));
        jLabel4.setText("Cart");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 80, -1, -1));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 110, 382, 298));
        ...
        jLabel6.setForeground(new java.awt.Color(58, 96, 110));
        ...
        txtCustomerName.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtCustomerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 470, 384, -1));
        ...
        txtCustomerMobileNumber.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtCustomerMobileNumber.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtCustomerMobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 540, 384, -1));
        ...
        txtCustomerEmail.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtCustomerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 610, 384, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(58, 96, 110));
        jLabel9.setText("Selected Product:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 420, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(58, 96, 110));
        ...
        txtProductName.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtProductName, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 470, 468, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(58, 96, 110));
        jLabel11.setText("Product Price: ");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 520, -1, -1));

        txtProductPrice.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtProductPrice.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtProductPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 540, 468, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(58, 96, 110));
        jLabel12.setText("Product Description");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 590, -1, -1));

        txtProductDescription.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtProductDescription.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtProductDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 610, 468, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(58, 96, 110));
        jLabel13.setText("Quantity:");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 650, -1, -1));

        txtOrderQuantity.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtOrderQuantity.setForeground(new java.awt.Color(1, 25, 54));
        getContentPane().add(txtOrderQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 670, 187, -1));

        jButton1.setBackground(new java.awt.Color(254, 147, 140));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 670, 153, 60));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(58, 96, 110));
        jLabel14.setText("Total Amount RS:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 420, -1, -1));

        lblFinalTotalPrice.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblFinalTotalPrice.setForeground(new java.awt.Color(58, 96, 110));
        lblFinalTotalPrice.setText("0000");
        getContentPane().add(lblFinalTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 420, -1, -1));

        btnSaveOrderDetails.setBackground(new java.awt.Color(254, 147, 140));
        btnSaveOrderDetails.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnSaveOrderDetails.setForeground(new java.awt.Color(255, 255, 204));
        ...
        getContentPane().add(btnSaveOrderDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 460, -1, -1));

        jButton3.setBackground(new java.awt.Color(254, 147, 140));
        ...
        getContentPane().add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 700, 100, 50));

        jLabel16.setForeground(new java.awt.Color(1, 25, 54));
    ...
    private void btnSaveOrderDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveOrderDetailsActionPerformed
        ...
        if (finalTotalPrice != 0 && !txtCustomerName.getText().equals("")) {
            ...
            if (tableCart.getRowCount() != 0) {
                for (int i = 0; i < tableCart.getRowCount(); i++) {
                    try {
                        Connection con = ConnectionProvider.getCon();
                        Statement st = con.createStatement();
                        st.executeUpdate("update product set quantity=quanity-" + Integer.parseInt(dtm.getValueAt(i, 2).toString()) + " where product_pk=" + Integer.parseInt(dtm.getValueAt(i, 0).toString()));
                    } catch (Exception e) {
                        JOptionPane.showMessageDialog(null, e);
                    }
                }
            ...
            try {
                ...
                doc.open();
                Paragraph projectName = new Paragraph("                                                                           SafeKeep: Inventory Management System\n");
                doc.add(projectName);
                ...
                PdfPCell subTotalPriceCell = new PdfPCell(new Phrase("Subtotal"));

                BaseColor backgroundColor = new BaseColor(254, 147, 140);
                ...
                doc.add(tb1);
                doc.add(starLine);
                Paragraph thanksMsg = new Paragraph("Thank you, Please Visit Us Again!");
                doc.add(thanksMsg);
